        ...
        ->add_fields(array( // type , slug , Titel of field
            ...
            ->set_render_callback(function ($block) {
                ...
                <?php if (esc_html($block['name_film']) !== '') { ?>
                    <h1 class="text-center card-title"><strong><?php echo esc_html($block['name_film']); ?></strong>
                    </h1>
                <?php } ?>
                ...
                <?php } ?>
                    ...
                    <h3 class="card-text"><strong>Director: </strong>  <?php echo esc_html($block['director']); ?></strong></h3>
                    
                    <h3 class="card-text"><strong>Description:</strong> </h3><p class="text-justify" > <?php echo esc_html($block['description_film']); ?></p>
                    ...
                    <?php
                        ...
                        foreach ($block['cast'] as $actor) {
                            ...
                            <figure class="figure p-1">
                                ...
                                <figcaption class="figure-caption text-center">  <?php echo esc_html($actor['actor']); ?></figcaption>
                            </figure>
                    ...
                    <div class="embed-responsive embed-responsive-16by9 mt-2">
                        ...
                        <iframe class="embed-responsive-item" src="<?php echo $link_video; ?>" width="640" height="360"
